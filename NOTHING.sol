...
contract NOTHING is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//0xD99D1c33F9fC3444f8101754aBC46c52416550D1) Test net
    ...
    //change router address fix 08
    function updateRouter(address _newDexAddress) external onlyOwner() {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        ...
        _numExcludedWallets = _numExcludedWallets+1; //fix issue 03/04
    }
    ...
    function _transfer(
        ...
        require(amount >= 0, "Transfer amount must be greater than zero"); //fix 05
